...
# Dit is een linux script, het kan ook gerund worden op Windows als Cygwin of MinGW is geinstalleerd.
# Indien dit niet het geval is, kan je het dot commando manueel uitvoeren als volgt:
#     dot voorbeeld.dot -Tpng -o voorbeeld.png
# Op de labo computers heb je vaak geen rechten om iets te installeren. Gebruik daarom de zip-versie:
